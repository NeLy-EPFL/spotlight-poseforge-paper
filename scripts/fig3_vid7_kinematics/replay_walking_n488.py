...
REPLAY_OUTPUT_DIR = get_outputs_dir() / "neuromechfly_replay/sim_data/nmf_hparamoptim_f1metric_nsga-ii_zonly_107/"
MIN_XY_CONF = 0.58
...
ADHFORCE_BY_LEG = {"lf": 0.44, "lm": 0.44, "lh": 0.44 * 1.16, "rf": 0.44, "rm": 0.44, "rh": 0.44 * 1.16}
ACTUATOR_GAIN = 68
JOINT_DAMPING = 0.55
SLIDING_FRICTION = 1.4
